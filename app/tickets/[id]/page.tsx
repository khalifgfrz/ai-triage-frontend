      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        ...
        <form action={resolveTicket} className="rounded-xl border border-border bg-card p-6">
          ...
          {ticket.status !== "RESOLVED" && (
            <button
              type="submit"
              className="mt-4 inline-flex items-center gap-2 rounded-lg bg-accent px-5 py-2.5 text-sm font-medium text-accent-foreground transition-colors hover:bg-accent/90"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
